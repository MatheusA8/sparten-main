...
<head>
    ...
    <title>Treino Funcional - Sparten</title>
    <style>
        .spinning-section {
            min-height: 100vh;
    ...
    <section class="spinning-section">
        <div class="spinning-container">
            <div class="spinning-header">
                ...
                <p>Melhore sua mobilidade, força e equilíbrio com o treinamento funcional.</p>
            </div>
            ...
            <div class="cta-section">
                ...
                <p>Escolha um horário e dia disponível para sua primeira aula de funcional</p>
